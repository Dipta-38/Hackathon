    ...
    <div class="col-lg-6">
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-body p-4 p-md-5">
                <h2 class="fw-bold mb-4">Transfer money</h2>
                ...
                <form method="POST" action="{{ route('transfer.store') }}" class="recipient-preview-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="memo" id="memo" class="form-control" maxlength="255" placeholder="Optional transfer note">
                    </div>

                    <button type="submit" class="btn btn-primary btn-lg w-100">{{ auth()->user()->otp_receiver_confirmation ? 'Generate receiver OTP' : 'Send funds' }}</button>
                </form>
            </div>
        </div>
    </div>
